...
class Smoke:
    ...
    def plotparticle(self, ax, alpha):
        ax.plot(self.position[0], self.position[1], 'o', markersize= 15, color= "grey" , alpha=alpha)               #Setting the shape, size and color of each particle
...
with open("lights3.csv", "r") as file:
    data = file.readlines()
...
smoke_machine1 = SmokeMachine((0, 200), num_smoke=50)                                                           # Position of machine and num of smoke particles set
smoke_machine2 = SmokeMachine((0, 100), num_smoke=50)                                                             # Position of machine and num of smoke particles set


#Sec11# Importing a picture of the band
image_path = "/home/20972008/Desktop/Fop Final Assignment/Scenario3/band3.png"                                                           #Setting a path to the png file
...
desired_height = 250                                                                                             #Setting the desired height for the picture in pixels
resized_image = image.resize((desired_width, desired_height))                                                    # Resizing the image into a resized image variable
x_position = 72                                                                                                  # setting X-coordinate of the image's position
y_position = 70                                                                                                  # setting Y-coordinate of the image's position


#Sec12# Importing a picture of the the background
image_path2 = "/home/20972008/Desktop/Fop Final Assignment/Scenario3/background3.jpeg"
...
image_path3 = "/home/20972008/Desktop/Fop Final Assignment/Scenario3/Logo3.png"
image3 = Image.open(image_path3)
desired_width3 = 200  # Desired width in pixels
desired_height3 = 200  # Desired height in pixels
...
def animate(i):
    ...
    ax.text(250, 30, 'Welcome to the concert, SPINAL-TAP',                                                #Creating a textbox with different customization
        fontsize=7,
        color='red',
        fontweight='bold',
    ...
    #Bottom Stage
    ax.fill([500, 0, 0, 500], [0, 0, 70, 70], color="yellow", edgecolor="black")
