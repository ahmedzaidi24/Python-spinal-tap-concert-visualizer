...
class Smoke:
    ...
    def plotparticle(self, ax, alpha):
        ax.plot(self.position[0], self.position[1], 'o', markersize= 3, color= "white" , alpha=alpha)               #Setting the shape, size and color of each particle
...
with open("lights.csv", "r") as file:
    data = file.readlines()
...
image_path = "/home/20972008/Desktop/Fop Final Assignment/Scenario1/band.png"                                                           #Setting a path to the png file
image = Image.open(image_path)                                                                                   #using PIL library to load the png into the image variable
desired_width = 400                                                                                              #Setting the desired width for the picture in pixels
desired_height = 300                                                                                             #Setting the desired height for the picture in pixels
resized_image = image.resize((desired_width, desired_height))                                                    # Resizing the image into a resized image variable
x_position = 60                                                                                                  # setting X-coordinate of the image's position
y_position = 70                                                                                                  # setting Y-coordinate of the image's position


#Sec12# Importing a picture of the the background
image_path2 = "/home/20972008/Desktop/Fop Final Assignment/Scenario1/background.jpg"
...
image_path3 = "/home/20972008/Desktop/Fop Final Assignment/Scenario1/tap-logo.png"
...
def animate(i):
    ...
    #Bottom Stage
    ax.fill([500, 0, 0, 500], [0, 0, 70, 70], color="red", edgecolor="black")
